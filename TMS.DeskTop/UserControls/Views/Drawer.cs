...
using TMS.DeskTop.UserControls.Data;
    ...
    public class Drawer : FrameworkElement
    {
        ...
        private void CreateContainer()
        {
            ...
            if (ShowMask)
            {
                ...
                _maskElement.MouseDown += MaskElement_PreviewMouseLeftButtonDown;
        ...
        private void OnIsOpenChanged(bool isOpen)
        {
            ...
            _windowContentElement = Content as UIElement;
