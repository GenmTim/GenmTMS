...
namespace Genm.Controls
{
    ...
    public class WindowDrawer : FrameworkElement
    {
        ...
        static WindowDrawer()
        {
            DataContextProperty.OverrideMetadata(typeof(WindowDrawer), new FrameworkPropertyMetadata(DataContextPropertyChanged));
        }

        public WindowDrawer()
        {
            Loaded += WindowDrawer_Loaded;
            Unloaded += WindowDrawer_Unloaded;
        }

        private void WindowDrawer_Loaded(object sender, RoutedEventArgs e)
        {
            if (IsOpen)
            {
        ...
        private void WindowDrawer_Unloaded(object sender, RoutedEventArgs e)
        {
            Loaded -= WindowDrawer_Loaded;
        ...
        private static void DataContextPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) =>
            ((WindowDrawer)d).OnDataContextPropertyChanged(e);
        ...
        public static readonly RoutedEvent OpenedEvent =
            EventManager.RegisterRoutedEvent("Opened", RoutingStrategy.Bubble,
                typeof(RoutedEventHandler), typeof(WindowDrawer));
        ...
        public static readonly DependencyProperty IsOpenProperty = DependencyProperty.Register(
            "IsOpen", typeof(bool), typeof(WindowDrawer), new FrameworkPropertyMetadata(ValueBoxes.FalseBox, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnIsOpenChanged));

        private static void OnIsOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var ctl = (WindowDrawer)d;
        ...
        public static readonly DependencyProperty MaskCanCloseProperty = DependencyProperty.Register(
            "MaskCanClose", typeof(bool), typeof(WindowDrawer), new PropertyMetadata(ValueBoxes.TrueBox));
        ...
        public static readonly DependencyProperty ShowMaskProperty = DependencyProperty.Register(
            "ShowMask", typeof(bool), typeof(WindowDrawer), new PropertyMetadata(ValueBoxes.TrueBox));
        ...
        public static readonly DependencyProperty DockProperty = DependencyProperty.Register(
            "Dock", typeof(Dock), typeof(WindowDrawer), new PropertyMetadata(default(Dock)));
        ...
        public static readonly DependencyProperty ShowModeProperty = DependencyProperty.Register(
            "ShowMode", typeof(DrawerShowMode), typeof(WindowDrawer), new PropertyMetadata(default(DrawerShowMode)));
        ...
        public static readonly DependencyProperty MaskBrushProperty = DependencyProperty.Register(
            "MaskBrush", typeof(Brush), typeof(WindowDrawer), new PropertyMetadata(default(Brush)));
        ...
        public static readonly DependencyProperty ContentProperty = DependencyProperty.Register(
            "Content", typeof(object), typeof(WindowDrawer), new PropertyMetadata(default(object)));
