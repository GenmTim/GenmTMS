...
namespace Genm.Controls
{
    public class Popup : System.Windows.Controls.Primitives.Popup
    {
        ...
        /// 是否顶置依赖属性（默认不顶置）
        /// </summary>
        public static readonly DependencyProperty IsTopmostProperty = DependencyProperty.Register("IsTopmost", typeof(bool), typeof(Popup), new FrameworkPropertyMetadata(false, OnIsTopmostChanged));
        ...
        public static readonly DependencyProperty IsMoveProperty =
            DependencyProperty.Register("IsMove", typeof(bool), typeof(Popup), new PropertyMetadata(true));
