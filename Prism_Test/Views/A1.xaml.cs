...
namespace Prism_Test.Views
{
    ...
    /// A1.xaml 的交互逻辑
    /// </summary>
    public partial class A1 : UserControl, INavigationAware
    {
        private readonly IRegionManager regionManager;

        public A1(IRegionManager regionManager)
        {
            InitializeComponent();
        ...
        public void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            this.regionManager.RequestNavigate("a1_region", next_view, param);
        }
    }
}
