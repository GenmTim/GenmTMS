...
namespace Prism_Test.Views
{
    ...
    /// A2.xaml 的交互逻辑
    /// </summary>
    public partial class A2 : UserControl, INavigationAware
    {
        private readonly IRegionManager regionManager;

        public A2(IRegionManager regionManager)
        {
            InitializeComponent();
        ...
        public void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            this.regionManager.RequestNavigate("a2_region", next_view, param);
        }
    }
}
